import { getAllTrainings, PaginationOptions, TrainingFilters } from "@/lib/api/trainings";
...
export async function GET(request: NextRequest) {
    try {
        ...
        if (searchParams.has("minDistance"))
            filters.minDistance = Number(searchParams.get("minDistance"));
        if (searchParams.has("maxDistance"))
            filters.maxDistance = Number(searchParams.get("maxDistance"));
        if (searchParams.has("minHeartRate"))
            filters.minHeartRate = Number(searchParams.get("minHeartRate"));
        if (searchParams.has("maxHeartRate"))
            filters.maxHeartRate = Number(searchParams.get("maxHeartRate"));
        ...
        if (searchParams.has("minElevation"))
            filters.minElevation = Number(searchParams.get("minElevation"));
        if (searchParams.has("maxElevation"))
            filters.maxElevation = Number(searchParams.get("maxElevation"));
        ...
        if (searchParams.has("hasHeartRateData"))
            filters.hasHeartRateData = searchParams.get("hasHeartRateData") === "true";
        if (searchParams.has("hasFitData"))
            filters.hasFitData = searchParams.get("hasFitData") === "true";
