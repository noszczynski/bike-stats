...
export async function fetchTrainings(
    ...
    if (filters.minHeartRate !== undefined)
        params.append("minHeartRate", filters.minHeartRate.toString());
    if (filters.maxHeartRate !== undefined)
        params.append("maxHeartRate", filters.maxHeartRate.toString());
    ...
    if (filters.hasHeartRateData !== undefined)
        params.append("hasHeartRateData", filters.hasHeartRateData.toString());
    if (filters.hasFitData !== undefined)
        params.append("hasFitData", filters.hasFitData.toString());
