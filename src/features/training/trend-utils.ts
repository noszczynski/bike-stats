...
export const isImprovement = (
    trend: number,
    metricTypeOrPositiveIsBetter: MetricType | boolean,
): boolean => {
...
export const getTrendMessage = (
    trend: number,
    metricTypeOrPositiveIsBetter: MetricType | boolean = true,
): string => {
    ...
    const isSpeechMetric =
        ...
        (metricTypeOrPositiveIsBetter === "heartRate" ||
            metricTypeOrPositiveIsBetter === "timePerKm");
