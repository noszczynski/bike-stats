...
export function NavUser() {
  ...
  const hasStravaError = error || (authData.user.hasStravaConnection && !athlete && !isAthleteLoading)
            ...
            <DropdownMenuGroup>
              {!user.hasStravaConnection ? (
                <DropdownMenuItem onClick={handleConnectStrava}>
                  <span className="text-[#FC4C02] font-medium">Połącz Strava</span>
                </DropdownMenuItem>
              ) : user.hasStravaError ? (
                <DropdownMenuItem onClick={handleConnectStrava}>
                  <span className="text-orange-600 dark:text-orange-400 font-medium">Ponów połączenie Strava</span>
                </DropdownMenuItem>
              ) : (
                <DropdownMenuItem onClick={handleDisconnectStrava}>
                  <span className="text-[#FC4C02] font-medium">Rozłącz Strava</span>
                </DropdownMenuItem>
              )}
            </DropdownMenuGroup>
            {(!user.hasStravaConnection || user.hasStravaError) && <DropdownMenuSeparator />}
