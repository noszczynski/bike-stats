                        ...
                        <AlertDescription className="text-green-800">
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-2 gap-2 text-sm">
                                    <div>
                                        Punkty GPS:{" "}
                                        {uploadResult.data.trackpoints_count.toLocaleString()}
                                    </div>
                                    <div>Segmenty: {uploadResult.data.laps_count}</div>
                                    <div>
                                        Czas: {formatDuration(uploadResult.data.activity_duration)}
                                    </div>
                                    <div>
                                        Dystans:{" "}
                                        {formatDistance(uploadResult.data.activity_distance)}
                                    </div>
                                    {uploadResult.data.device && (
                                        <div className="col-span-2">
                                            Urządzenie: {uploadResult.data.device}
                                        </div>
                                    )}
                                </div>
                            </div>
